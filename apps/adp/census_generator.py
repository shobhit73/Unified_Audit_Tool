        ...
        if data_key not in st.session_state:
            with st.spinner("Preparing downloads..."):
                ...
                st.session_state[data_key] = {
                    ...
                    # ingest this CSV match the first header literally as "Associate
                    # ID"; a utf-8-sig BOM smuggles a U+FEFF in front and the column
                    # lookup silently misses (Skyland incident, 2026).
