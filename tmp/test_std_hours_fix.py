...
# Mocking some streamlit behavior or just testing the logic directly
def test_std_hours_fix():
    # Simulate the logic I added to census_generator.py
    data = {
    ...
    actual_values = df_download['Working hours per Week'].tolist()
