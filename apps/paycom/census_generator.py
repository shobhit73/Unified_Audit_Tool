...
def render_auto_fix_options(key_prefix):
    ...
    with col_fix1:
        ...
        fix_driver_smart = st.checkbox("Enable Smart Driver Correction (Dept/Job -> FLSA/Pay Type)", value=False, key=f"{key_prefix}_fix_driver_smart", help="Full driver automation: 1. Fills blank Position from 'Driver' departments. 2. Sets BLANK FLSA to Non-Exempt. 3. Sets BLANK Pay Type to 'Hourly'. It will NOT replace existing data.")
